#!/bin/bash
#SBATCH --job-name=split_rna_rna3db_filtered_rrna    # Job name
#SBATCH --ntasks=1                # Run on a single CPU
#SBATCH --cpus-per-task=64
#SBATCH --mem=96gb                # Job memory request
#SBATCH --partition=bigmem
#SBATCH --time=96:00:00           # Time limit hrs:min:sec
#SBATCH --output=split_rna_rna3db_filtered_rrna.log       # Standard output and error log
...
# Directories
PDB_DIR="../hariboss_process/complex_mmcif_database"
OUTPUT_DIR="./output_filtered"
INDEX_DATA="../hariboss_process/hariboss_clean_20240621_error_revised.csv"
